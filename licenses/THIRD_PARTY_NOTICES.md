...
Note: `libvgm` contains multiple cores and source files under different licenses. The relevant license texts for the cores used by ctrmml-cmd are included in this directory. Please refer to each listed license file for the exact terms and any distribution obligations.
